...
var map = {
	"./admin/admin.module": [
		...
		"default~admin-admin-module~candidate-candidate-module~home-home-module~list-job-list-job-module~logi~fb055ef2",
		"default~admin-admin-module~candidate-candidate-module~detail-job-detail-job-module~home-home-module~~cc89b5b1",
		"default~admin-admin-module~candidate-candidate-module~home-home-module~list-job-list-job-module~teac~34fd75ac",
		"default~admin-admin-module~candidate-candidate-module~home-home-module~test-test-module",
		"default~admin-admin-module~candidate-candidate-module~home-home-module~list-job-list-job-module",
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        ///cai nay ne
        this.soketIo.listen("ServerNotify").subscribe(function (data) {
            _this.notyfy = data;
            // alert(this.notyfy);
            //localStorage.setItem("duLieu",data+"");
        });
    ...
    HeaderComponent.prototype.Xem = function () {
        this.notyfy = "0";
        this.soketIo.emit("ServerUpdateNotify", "");
    };
